...
public:
	...
	bool square_trajectory(double t, double heigth, KDL::Frame& pos_d, KDL::Twist& vel_d );
	bool square_initialize(double time, const KDL::Frame& start, const KDL::Frame& final);
	bool complete_square_trajectory(std::map<double, KDL::Frame>& pos_trj, std::map<double, KDL::Twist>& vel_trj, double heigth, double delta_t=0.01);
